...
- 🟡 進行中: なし
- 🔜 次の一歩: **SPEC §9 ロードマップに従って Round 171 から実装**。 ① Round 171: 「📋 一覧」 タブ完全廃止 (RaceList コンポーネント削除 + ナビから除去) → ② Round 172: 買い目 5,000 円配分統一 → ③ Round 173: 「⚙️ 設定」 タブ 4 項目化 (ログイン/ログアウト/データ削除/通知 ON/OFF) → ④ Round 174: ホーム強化 → ⑤ Round 175: 「🔬 研究所」 タブ整理。
